...
<?php
$req = $bdd->query("SELECT art.art_id, art.art_titre, art.art_contenu, art.art_image, art.art_datePublication, art.art_url, cat.cat_nom, uti.user_id ,uti.user_login FROM article art
...
foreach ($donnee as $article) {?>
    ...
    <div class="row align-items-center my-5 shadow-sm" style="height: 250px;">
        ...
        <div class="col-lg-8">
            ...
            <h2 class="font-weight-light"><a href="article_solo.php?url=<?php echo $article->art_url ?>"><?php echo $article->art_titre;  ?></a></h2>
